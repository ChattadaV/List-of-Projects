    ...
    with open(output_csv, mode='a', newline='') as file:
        ...
        if file.tell() == 0:
            writer.writerow([
                ...
                'Number of Instrument Approaches', 'Type and Location of Instrument Approaches', 'Airplane Single Time', 'Airplane Multi Time', 
                'Instrument Actual Time', 'Instrument Simulated (Hood) Time', 'Instrument FTD/Simulator Time',
                'Night Time', 'Day Cross Country Time (All)', 'Day Cross Country Time (>50 NM)', 
                'Night Cross Country Time (All)', 'Night Cross Country Time (>50 NM)', 'PIC Time', 'Solo Time', 
                'Ground Training Received Time', 'Flight Training Received Time', 'Flight Training Given Time',
                'Total Flight Time', 'Remarks'          
            ])
...
# output_html = 'flight_path_map_2024.08.23-formatted.html'
# visited_airports_csv = 'visited_airport_2024.08.23-formatted.csv'
# maneuvers_csv = 'maneuvers_2024.08.23.csv'

# input_csv = 'csv_cleaned_2024.10.09.csv'
# output_html = 'flight_path_map_2024.10.15-formatted.html'
# visited_airports_csv = 'visited_airport_2024.10.15-formatted.csv'
...
# Extract date from flight_date and format it for the map HTML filename
# map_html = f"map_{flight_date.strftime('%m-%d-%Y')}.html"

# input_csv = 'csv_cleaned_2024.10.15.csv'

# make_and_model = 'PA28-150'
# instrument_approach_num = 0
# instrument_approach_type_location = 'N/A'
# airplane_single = True
# airplane_multi = False
# instrument_actual_time = 0
# instrument_simulated_hood_time = 0
# instrument_simulator_ftd_time = 0
# pic = True
# solo = True
# ground_training_received_time = 0
# flight_training_received_time = 0
# flight_training_given_time = 0
